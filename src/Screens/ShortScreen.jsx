						...
						<div className="product-info">
							<div className="nav-main">
								...
								<ul className="nav nav-tabs" id="myTab" role="tablist">
									...
									<li className="nav-item"><a className="nav-link active" data-toggle="tab" href="#Shorts" role="tab">Shorts</a></li>
							...
							<div className="tab-content" id="myTabContent">
								...
								{/*<!--/ End Single Tab -->*/}
								{/*<!-- Start Single Tab -->*/}
								<div className="tab-pane fade show active" id="shorts" role="tabpanel">
									<div className="tab-single">
										<div className="row">
											{Shorts.map(s => (

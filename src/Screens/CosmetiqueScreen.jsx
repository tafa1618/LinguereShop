						...
						<div className="product-info">
							<div className="nav-main">
								...
								<ul className="nav nav-tabs" id="myTab" role="tablist">
									<li className="nav-item"><a className="nav-link active" data-toggle="tab" href="#cosmetique" role="tab">Cosmétiques</a></li>
							...
							<div className="tab-content" id="myTabContent">
									{/*<!-- Start Single Tab -->*/}
									<div className="tab-pane fade show active" id="cosmetique" role="tabpanel">

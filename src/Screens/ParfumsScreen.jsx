						...
						<div className="product-info">
							<div className="nav-main">
								...
								<ul className="nav nav-tabs" id="myTab" role="tablist">
									...
									<li className="nav-item"><a className="nav-link active" data-toggle="tab" href="#Parfums" role="tab">Parfums</a></li>
							...
							<div className="tab-content" id="myTabContent">
								...
								{/*<!-- Start Single Tab -->*/}
								<div className="tab-pane fade show active" id="Parfums" role="tabpanel">
									<div className="tab-single">
										<div className="row">
											{Parfums.map(sa => (
